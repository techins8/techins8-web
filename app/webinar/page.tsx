...
export const metadata: Metadata = {
  ...
  description:
    "Rejoignez notre webinaire exclusif pour découvrir comment FreeMatch aide les freelances tech à trouver leur contrat idéal en seulement 7 jours, en y consacrant 15 minutes par jour.",
  openGraph: {
    title: "Webinaire FreeMatch : Trouvez votre contrat idéal en 7 jours",
    description:
      "Rejoignez notre webinaire exclusif pour découvrir comment FreeMatch aide les freelances tech à trouver leur contrat idéal en seulement 7 jours, en y consacrant 15 minutes par jour.",
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <p className="text-black text-lg md:text-xl max-w-[700px] mb-6">
              Découvrez comment FreeMatch aide les freelances tech à trouver leur job en 15 minutes
              par jour.
            </p>
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold tracking-tighter text-title mb-4">
              Le <span className="text-accent-foreground">cauchemar</span> de la recherche
              d&apos;emploi pour les freelances tech
            </h2>
            <p className="text-muted-foreground text-lg max-w-[800px] mx-auto">
              Les freelances tech perdent en moyenne 15 heures par semaine à chercher sur plusieurs
              plateformes, à gérer des offres trompeuses et des attentes irréalistes.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div className="bg-card rounded-lg shadow-md p-6">
              ...
              <p className="text-muted-foreground">
                Les freelances tech passent en moyenne 15 heures par semaine à chercher sur
                plusieurs plateformes pour leur prochain contrat.
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg shadow-md p-6">
              ...
              <p className="text-muted-foreground">
                Des emplois &quot;à distance&quot; qui nécessitent en réalité une présence sur site
                ou ont des restrictions géographiques.
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg shadow-md p-6">
              ...
              <p className="text-muted-foreground">
                Des offres qui prétendent être dans votre ville mais qui nécessitent en réalité une
                relocalisation ou des déplacements importants.
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg shadow-md p-6">
              ...
              <p className="text-muted-foreground">
                Des projets avec des budgets bien inférieurs aux tarifs du marché pour
                l&apos;expertise et l&apos;expérience requises.
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="text-center">
                <p className="text-muted-foreground mb-2">
                  Opportunités manquées pendant la recherche :
                </p>
      ...
      <section id="solution-section" className="py-16 bg-accent/5">
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold tracking-tighter text-title mb-4">
              Découvrez <span className="text-accent-foreground">FreeMatch</span> : Votre assistant
              IA de recherche de contrat
            </h2>
            <p className="text-muted-foreground text-lg max-w-[800px] mx-auto mb-12">
              FreeMatch révolutionne la façon dont les freelances tech trouvent leur prochain
              contrat en combinant une agrégation multi-plateformes et un matching propulsé par
              l&apos;IA.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="bg-card rounded-lg shadow-md p-6">
              ...
              <p className="text-muted-foreground">
                Nous analysons toutes les principales plateformes freelance et job boards pour
                centraliser chaque opportunité en un seul endroit.
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg shadow-md p-6">
              ...
              <p className="text-muted-foreground">
                Notre algorithme propriétaire analyse chaque annonce et l&apos;évalue en fonction de
                vos compétences, tarifs et préférences.
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg shadow-md p-6">
              ...
              <p className="text-muted-foreground">
                Importez votre profil Malt instantanément pour configurer vos préférences sans
            ...
            <div className="bg-card rounded-lg shadow-md p-6">
              ...
              <p className="text-muted-foreground">
                Nous vérifions les détails des offres pour garantir que la localisation, les options
                de télétravail et les tarifs sont correctement représentés.
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Consultez votre flux d&apos;opportunités personnalisé, avec chaque offre évaluée
                  et classée par notre IA en fonction de votre profil et de vos préférences.
                </p>
          ...
          <div className="mt-16 bg-card rounded-lg shadow-lg p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="text-center">
                <p className="text-muted-foreground mb-2">
                  Temps passé à chercher un emploi avec FreeMatch :
                </p>
      ...
      <section className="py-16 bg-background">
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-[800px] mx-auto mb-12">
              Découvrez ce que les freelances disent de la façon dont FreeMatch a transformé leur
          ...
          <div className="grid gap-8 md:grid-cols-3 mb-16">
            <div className="bg-card p-6 rounded-lg shadow-md">
              ...
              <p className="italic mb-6">
                Avant FreeMatch, je passais plus de temps à chercher du travail qu&apos;à travailler
                sur des projets. Maintenant, je ne vérifie que 15 minutes par jour et j&apos;ai déjà
                trouvé deux excellents contrats.
              </p>
            ...
            <div className="bg-card p-6 rounded-lg shadow-md">
              ...
              <p className="italic mb-6">
                Le scoring IA est parfaitement précis. Il m&apos;a aidée à prioriser les
                opportunités à poursuivre, et j&apos;ai décroché un contrat qui correspond
                parfaitement à mes compétences et à mes exigences tarifaires.
              </p>
              <div className="mt-auto">
            ...
            <div className="bg-card p-6 rounded-lg shadow-md">
              ...
              <p className="italic mb-6">
                L&apos;importation en un clic depuis Malt a tout changé. Mon profil a été configuré
                en quelques secondes, et les correspondances ont commencé à arriver immédiatement.
      ...
      <section id="webinar-benefits" className="py-16 bg-accent/5">
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-[800px] mx-auto mb-12">
              Rejoignez-nous pour découvrir comment FreeMatch révolutionne le processus de recherche
              d&apos;emploi pour les professionnels tech.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold">
                      Le problème actuel de la recherche d&apos;emploi
                    </h4>
                    <p className="text-muted-foreground">
                      Pourquoi la recherche d&apos;emploi traditionnelle fait perdre 15+ heures par
                      semaine aux freelances tech
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Découvrez notre système de matching propulsé par l&apos;IA en action
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Comment notre algorithme propriétaire classe les opportunités selon votre
                      profil spécifique
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Exemples concrets de freelances qui ont trouvé leur contrat idéal en 7 jours
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Obtenez des réponses à vos questions spécifiques en direct
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container px-4 md:px-6 max-w-4xl mx-auto">
          <div className="bg-card rounded-xl shadow-xl p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-lg max-w-[800px] mx-auto">
                Sécurisez votre place à notre webinaire exclusif et soyez parmi les premiers à
                accéder à FreeMatch.
              </p>
            </div>
            ...
            <div className="flex items-start mb-6">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="terms" className="text-muted-foreground">
                  J&apos;accepte de recevoir des emails concernant FreeMatch. Je comprends que je
                  peux me désabonner à tout moment. Consultez notre{" "}
            ...
            <button
              type="button"
              className="w-full bg-accent text-accent-foreground hover:bg-accent/90 py-3 px-4 rounded-md font-medium transition-colors"
            >
              Réserver ma place
            </button>

            <p className="text-center text-sm text-muted-foreground mt-4">
              En vous inscrivant, vous recevrez un enregistrement même si vous ne pouvez pas
              assister en direct.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4">
              ...
              <details className="group" open>
                <summary className="flex items-center justify-between p-6 cursor-pointer">
                  <h3 className="text-lg font-semibold">
                    Qu&apos;est-ce que FreeMatch exactement ?
                  </h3>
                ...
                <div className="px-6 pb-6 text-muted-foreground">
                  <p>
                    FreeMatch est une plateforme propulsée par l&apos;IA qui agrège des opportunités
                    de contrats tech provenant de multiples sources, les analyse et vous présente
                    des correspondances personnalisées basées sur vos compétences, vos exigences
                    tarifaires et vos préférences.
                  </p>
                </div>
              </details>
            </div>
            ...
            <div className="bg-card rounded-lg shadow-sm overflow-hidden">
              <details className="group">
                ...
                <div className="px-6 pb-6 text-muted-foreground">
                  <p>
                    Oui, le webinaire est entièrement gratuit. Nous croyons en l&apos;importance de
                    fournir de la valeur d&apos;abord et de laisser notre plateforme parler
                    d&apos;elle-même. Vous obtiendrez des informations pratiques, que vous décidiez
                    ou non d&apos;utiliser FreeMatch par la suite.
                  </p>
                </div>
              </details>
            </div>
            ...
            <div className="bg-card rounded-lg shadow-sm overflow-hidden">
              <details className="group">
                <summary className="flex items-center justify-between p-6 cursor-pointer">
                  <h3 className="text-lg font-semibold">
                    Que se passe-t-il si je ne peux pas assister au webinaire en direct ?
                  </h3>
                  <div className="relative ml-2 flex-shrink-0 rounded-full border group-open:rotate-180 transition-transform">
                    <ChevronDown className="h-5 w-5" />
                  </div>
                ...
                <div className="px-6 pb-6 text-muted-foreground">
                  <p>
                    Pas de problème ! Tous ceux qui s&apos;inscrivent recevront un enregistrement du
                    webinaire. Cependant, les participants en direct auront l&apos;opportunité de
                    participer à la session de questions-réponses et recevront des bonus exclusifs
                    non disponibles pour ceux qui regardent uniquement l&apos;enregistrement.
                  </p>
                </div>
              </details>
            </div>
            ...
            <div className="bg-card rounded-lg shadow-sm overflow-hidden">
              <details className="group">
                <summary className="flex items-center justify-between p-6 cursor-pointer">
                  <h3 className="text-lg font-semibold">
                    Comment fonctionne le système de notation IA de FreeMatch ?
                  </h3>
                  <div className="relative ml-2 flex-shrink-0 rounded-full border group-open:rotate-180 transition-transform">
                    <ChevronDown className="h-5 w-5" />
                  </div>
                ...
                <div className="px-6 pb-6 text-muted-foreground">
                  <p>
                    Notre système de notation IA propriétaire analyse plus de 50 points de données
                    pour chaque opportunité de contrat et les compare à votre profil, vos
                    compétences, vos attentes tarifaires et vos préférences. Il attribue ensuite un
                    score de correspondance de 0 à 100, vous aidant à prioriser les opportunités à
                    poursuivre en premier.
                  </p>
                </div>
              </details>
            </div>
            ...
            <div className="bg-card rounded-lg shadow-sm overflow-hidden">
              <details className="group">
                <summary className="flex items-center justify-between p-6 cursor-pointer">
                  <h3 className="text-lg font-semibold">
                    FreeMatch est-il uniquement destiné aux freelances tech ?
                  </h3>
                  <div className="relative ml-2 flex-shrink-0 rounded-full border group-open:rotate-180 transition-transform">
                    <ChevronDown className="h-5 w-5" />
                  </div>
                ...
                <div className="px-6 pb-6 text-muted-foreground">
                  <p>
                    Actuellement, oui. Nous nous sommes d&apos;abord concentrés sur le secteur tech
                    car c&apos;est là que nous avons constaté le plus grand écart entre le talent et
                    la correspondance des opportunités. Notre plateforme est optimisée pour les
                    développeurs, les designers, les chefs de produit, les data scientists et autres
                    rôles tech. Nous pourrons étendre à d&apos;autres secteurs à l&apos;avenir.
                  </p>
                </div>
              </details>
            </div>
            ...
            <div className="bg-card rounded-lg shadow-sm overflow-hidden">
              <details className="group">
                ...
                <div className="px-6 pb-6 text-muted-foreground">
                  <p>
                    FreeMatch propose des formules gratuites et premium. Les fonctionnalités de base
                    sont gratuites, tandis que la mise en relation avancée et l&apos;accès
                    prioritaire aux meilleures opportunités nécessitent un abonnement premium. Les
                    participants au webinaire bénéficieront de tarifs spéciaux et d&apos;offres
                    exclusives non disponibles pour le grand public.
                  </p>
                </div>
              </details>
            </div>
          ...
          <div className="rounded-xl bg-accent p-8 md:p-12 shadow-lg relative overflow-hidden">
            ...
            <div className="relative z-10 text-center max-w-3xl mx-auto">
              ...
              <p className="text-white/80 text-lg mb-8">
                Rejoignez notre webinaire gratuit et découvrez comment FreeMatch peut vous aider à
                trouver des contrats tech parfaitement adaptés à vos compétences et à vos exigences
                tarifaires.
              </p>
              <Link
