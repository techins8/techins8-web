  ...
  return (
    <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="p-6 pt-2">
        <div className="flex items-center mt-4 space-x-2">
          ...
          <div className="overflow-hidden">
            ...
            <div className="text-sm text-gray-500 flex items-center space-x-2">
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger>{publishedAt.toLocaleDateString("fr-FR")}</TooltipTrigger>
                  <TooltipContent>
                    <p>
        ...
        <p className="mt-2 text-gray-600 h-32 line-clamp-4" title={article.teaser}>
          {article.teaser}
        </p>
        <div className="flex items-center mt-4 space-x-2">
          {article.tags.multi_select.map((tag) => (
            <Badge key={tag.id} className="bg-blue-100 text-blue-600 hover:bg-blue-100">
              {tag.name}
            </Badge>
          ))}
        </div>
