...
export const metadata: Metadata = {
  title: 'Conditions Générales de Vente - TechIns8',
  description: 'Conditions Générales de Vente des services TechIns8',
};
  ...
  const sections = [
    {
      ...
      content: "TechIns8, Société par Actions Simplifiée au capital de 2 000,00 euros, dont le siège social est situé au 60 rue François 1er, 75008 Paris, immatriculée au RCS de Paris sous le numéro 938 964 061, représentée par Monsieur Lucien Arbieu-Lemenan en qualité de Président.",
      subsections: [
        {
          subtitle: "1.1 - Services proposés",
          content: "TechIns8 propose une solution d'analyse d'offres d'emploi par intelligence artificielle comprenant :",
          items: [
      ...
      subsections: [
        {
          ...
          items: [
            "'Le Service' désigne l'ensemble des fonctionnalités proposées par TechIns8",
            "'L'Utilisateur' désigne toute personne physique ou morale utilisant le Service",
            "'L'Abonnement' désigne la souscription aux services premium de TechIns8",
            "'Le Site' désigne la plateforme web accessible à l'adresse www.techins8.com"
          ]
        }
      ]
    },
    {
      ...
      content: "Les présentes CGV sont applicables à toute souscription d'un abonnement TechIns8. Elles sont accessibles à tout moment sur le Site et prévalent sur toute autre version ou document contradictoire."
    },
    {
    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
            ...
            content: "La résiliation d'un abonnement peut être effectuée à tout moment depuis votre espace client. En résiliant votre abonnement :",
            items: [
    ...
    },
    {
      ...
      content: "Conformément à l'article L221-18 du Code de la consommation, l'Utilisateur dispose d'un délai de 14 jours pour exercer son droit de rétractation sans avoir à motiver sa décision.",
      items: [
        "Le délai court à compter de la souscription de l'abonnement",
        "La demande doit être envoyée par email à contact@techins8.com",
    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          content: "TechIns8 ne peut être tenu responsable :",
          items: [
    ...
    },
    {
        ...
        content: "TechIns8 reste propriétaire de l'ensemble des droits de propriété intellectuelle sur les études, dessins, modèles, prototypes, etc., réalisés en vue de la fourniture des services.",
        subsections: [
          {
            subtitle: "8.1 - Protection du contenu",
            items: [
              "L'ensemble des éléments du service TechIns8 est protégé par le droit d'auteur",
              "Les analyses générées par notre IA restent la propriété de TechIns8",
      ...
      },
      {
        ...
        content: "TechIns8 s'engage à protéger les données personnelles de ses utilisateurs conformément au RGPD.",
        subsections: [
          {
            ...
            items: [
              ...
              "L'utilisateur peut exercer ses droits via contact@techins8.com",
      ...
      },
      {
        ...
        content: "TechIns8 met à disposition un service client pour accompagner ses utilisateurs.",
        subsections: [
          {
            subtitle: "10.1 - Support technique",
            items: [
              "Assistance par email à contact@techins8.com",
      ...
      },
      {
        ...
        content: "TechIns8 se réserve le droit de modifier les présentes CGV à tout moment.",
        items: [
        ...
        subsections: [
          ...
          },
          {
            ...
            items: [
              ...
              "Les réclamations doivent être adressées à contact@techins8.com",
      ...
      },
      {
        ...
        content: "TechIns8 ne pourra être tenue responsable en cas d'inexécution de ses obligations due à un cas de force majeure tel que défini par l'article 1218 du Code civil.",
        items: [
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <header className="text-center mb-12">
            ...
            <p className="text-gray-600">
              En vigueur au 27 décembre 2024
            </p>
          </header>
